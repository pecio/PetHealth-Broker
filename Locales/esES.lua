...
L['Play Sound Alert'] = 'Alerta de Sonido'
L['Play the Level Up sound when cooldown finishes'] = 'Reproducir el sonido de Subir de Nivel cuando el tiempo de reutilización termina'
